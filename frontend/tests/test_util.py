...
@pytest.mark.parametrize(
    ...
    [
        # Single day
        (datetime(2024, 9, 2), datetime(2024, 9, 2), "September 2, 2024"),
        # Full months
        (datetime(2024, 8, 1), datetime(2024, 8, 31), "August 2024"),
        (datetime(2024, 2, 1), datetime(2024, 2, 29), "February 2024"),  # Leap year
        (datetime(2025, 2, 1), datetime(2025, 2, 28), "February 2025"),  # Non-leap year
        # Date range within a month
        (datetime(2024, 7, 1), datetime(2024, 7, 23), "1st to 23rd July 2024"),
        (datetime(2024, 7, 2), datetime(2024, 7, 23), "2nd to 23rd July 2024"),
        # Date range across months
        (datetime(2024, 6, 3), datetime(2024, 10, 7), "June 3 to October 7, 2024"),
        (
            datetime(2024, 11, 28),
            datetime(2025, 1, 5),
            "November 28 to January 5, 2024",
        ),
        # Full year
        (datetime(2024, 1, 1), datetime(2024, 12, 31), "Year 2024"),
        # Week
        (datetime(2024, 9, 2), datetime(2024, 9, 8), "Week of September 2, 2024"),
        ...
        # Edge cases
        (datetime(2024, 12, 31), datetime(2024, 12, 31), "December 31, 2024"),
        (datetime(2024, 1, 1), datetime(2024, 1, 1), "January 1, 2024"),
        (datetime(2024, 2, 29), datetime(2024, 2, 29), "February 29, 2024"),  # Leap day
    ],
)
