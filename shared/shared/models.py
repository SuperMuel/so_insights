...
class Topic(BaseModel):
    ...
    title: str = Field(..., description="Concise title summarizing the topic")

    body: str = Field(
        ..., description="Detailed body describing the topic, generated by AI"
    )

    body_with_links: str | None = Field(
        default=None,
        description="Body with links to the articles, formatted in the style [[number]](url)]",
    )

    first_image: HttpUrl | None = Field(
        default=None,
        description="URL of a representative image for the topic, if available",
    )
...
class AgenticAnalysisResult(BaseModel):
    ...
    topics: list[Topic] = Field(
        ..., description="List of topics generated by the agentic analysis"
    )

    summary: str = Field(..., description="Overall summary of the agentic analysis")

    relevant_articles_ids: list[PydanticObjectId] = Field(
        description="IDs of articles deemed relevant and used in the report",
    )


AnalysisResult = ClusteringAnalysisResult | AgenticAnalysisResult
...
#         ..., description="ID of the workspace this topic belongs to"
#     )
#     analysis_run_id: Annotated[PydanticObjectId, Indexed()] = Field(
#         ..., description="ID of the analysis run that generated this topic"
#     )
#     articles_ids: list[PydanticObjectId] = Field(
#         ..., description="IDs of articles associated with the topic"
#     )
...
#     class Settings:
#         name = db_settings.mongodb_topics_collection
